...
public:
    ...
    bool TrySelectEnemySpawn(int frame, EnemySpawnRule& spawn, int& chapterNumber) const override {
        ...
        static constexpr EnemySpawnRule Chapter1[] = {
            {BasicEnemy, 35, 70, 1.08f, -0.72f, -0.54f, 60.0f},
            {StraightShooterEnemy, 160, 360, 1.10f, -0.18f, 0.86f, 48.0f}
        };
        // チャプター2は通常機、円形弾幕砲台、重装機を出現させる
        static constexpr EnemySpawnRule Chapter2[] = {
            {BasicEnemy, 525, 65, 1.12f, 0.42f, -0.12f, 60.0f},
            {CircleShooterEnemy, 580, 210, 1.14f, 0.35f, -0.32f, 54.0f},
            {HeavyEnemy, 650, 280, 1.16f, 0.70f, 0.58f, 60.0f}
        };
        // チャプター3は直進狙撃機、円形弾幕砲台、重装機を出現させる
        static constexpr EnemySpawnRule Chapter3[] = {
            {StraightShooterEnemy, 1020, 160, 1.10f, -0.78f, 0.86f, 48.0f},
            {CircleShooterEnemy, 1080, 200, 1.14f, 0.78f, -0.86f, 36.0f},
            {HeavyEnemy, 1160, 220, 1.16f, 0.22f, 0.30f, 60.0f}
        };
        constexpr Chapter Chapters[] = {
            {0, 500, Chapter1, 2}, {500, 1000, Chapter2, 3}, {1000, 1500, Chapter3, 3}
        };
